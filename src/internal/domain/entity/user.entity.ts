...
export class UserEntity {
  ...
  static Create(queryResult: UserEntity): UserEntity {
    return new UserEntity(
      ...
      queryResult.email,
      queryResult.activity_status,
      queryResult.password,
      queryResult.national_id,
      queryResult.total_verification_count_in_day,
      queryResult.role,
      queryResult.sex,
      queryResult.birthday,
      queryResult.last_verification_time,
  ...
  mapToModel(): User {
    return new User(
      ...
      this.password,
      this.national_id,
      this.total_verification_count_in_day,
      this.role,
      this.sex,
      new Date(this.birthday),
      new Date(this.last_verification_time),
